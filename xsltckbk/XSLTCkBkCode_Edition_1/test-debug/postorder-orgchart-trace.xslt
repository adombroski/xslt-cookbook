...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:trace="http://www.obqo.de/XSL/Trace" 
 xmlns:Pause="java:com.ora.XSLTCookbook.Pause" version="1.1" exclude-result-prefixes="Pause trace">
...
<xsl:strip-space elements="*"/>
   ...
   stack: </alias:text><alias:value-of select="$trace:current"/><alias:text> (</alias:text><alias:text>match="/employee"</alias:text><alias:text>)</alias:text></alias:message>
   ...
   stack: </alias:text><alias:value-of select="$trace:current"/><alias:text> (</alias:text><alias:text>match="employee[employee]"</alias:text><alias:text>)</alias:text></alias:message>
		<xsl:apply-templates><alias:with-param xmlns:alias="http://www.w3.org/1999/XSL/Transform" name="trace:callstack" select="$trace:current"/></xsl:apply-templates>
   ...
   stack: </alias:text><alias:value-of select="$trace:current"/></alias:message>
		<xsl:choose>
