...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:math="http://www.exslt.org/math" exclude-result-prefixes="math" xmlns:test="http://www.ora.com/XSLTCookbook/test" id="math:math.min">
...
-->
  ...
  <xsl:template match="xsl:stylesheet[@id='math:math.power'] | xsl:include[@href='math.min.xslt']">
    <xsl:message>
TESTING math.min
</xsl:message>
