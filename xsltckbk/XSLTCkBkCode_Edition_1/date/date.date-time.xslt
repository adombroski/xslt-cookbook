...
<xsl:template name="date:hebrew-calendar-ellapsed-days">
	<xsl:param name="year"/>
...
<xsl:template name="date:days-in-hebrew-year">
	<xsl:param name="year"/>
...
<xsl:template name="date:last-day-of-hebrew-month">
	<xsl:param name="month"/>
	<xsl:param name="year"/>
	...
	<xsl:variable name="long-heshvan">
	  <xsl:call-template name="date:long-heshvan">
	    <xsl:with-param name="year" select="$year"/>
	  </xsl:call-template>
	</xsl:variable>

	<xsl:variable name="short-kislev">
	  <xsl:call-template name="date:short-kislev">
	    <xsl:with-param name="year" select="$year"/>
	  </xsl:call-template>
	</xsl:variable>
...
<xsl:template name="date:fixup-hebrew-year">
...
<xsl:template name="date:fixup-hebrew-month">
	<xsl:param name="year"/>
...
<xsl:template match="/xsl:stylesheet[@id = 'date:date-time']" priority="-1000">
<results>
<!--
	<result>
	<xsl:call-template name="date:julian-day-to-date">
	...
	<xsl:call-template name="date:absolute-day-to-iso-date">
		<xsl:with-param name="abs-day" select="730909"/>
	</xsl:call-template>
	</result>
	
	<result>
	<xsl:call-template name="date:julian-day-to-julian-date">
		<xsl:with-param name="j-day" select="0"/>
	</xsl:call-template>
	</result>
	...
	<xsl:call-template name="date:absolute-day-to-islamic-date">
	...
	<xsl:call-template name="date:absolute-day-to-hebrew-date">
...
-->
    ...
    <xsl:call-template name="date:format-date-time">
      ...
      <xsl:with-param name="format" select="'%Y-%m-%dT%H:%M:%S%z So Wake Up!'"/>
	</xsl:call-template>
</result>
